...
@Entity(name = "coefficientConstruction")
@Table(name = "COEFFCIENT_CONSTRUCTION")
public class CoefficientConstruction extends AuditEntity {
    ...
    public boolean equals(Object o) {
        ...
        CoefficientConstruction that = (CoefficientConstruction) o;
